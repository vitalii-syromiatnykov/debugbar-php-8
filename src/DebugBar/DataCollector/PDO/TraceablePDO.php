...
class TraceablePDO extends PDO
{
     ...
     */
    #[\ReturnTypeWillChange] public function errorCode()
    {
     ...
     * @return array PDO::errorInfo returns an array of error information
     */
    #[\ReturnTypeWillChange] public function errorInfo()
    {
     ...
     */
    #[\ReturnTypeWillChange] public function getAttribute($attribute)
    {
     ...
     */
    #[\ReturnTypeWillChange] public function inTransaction()
    {
     ...
     */
    #[\ReturnTypeWillChange] public function lastInsertId($name = null)
    {
   ...
   * the statement, PDO::prepare returns FALSE or emits PDOException (depending on error handling).
	 */
    #[\ReturnTypeWillChange] public function prepare($statement, $driver_options = [])
    {
   ...
   * failure.
   */
    #[\ReturnTypeWillChange] public function query($statement, $fetchMode = null, ...$fetchModeArgs)
    {
     ...
     */
    #[\ReturnTypeWillChange] public function quote($string, $parameter_type = PDO::PARAM_STR)
    {
     ...
     * @return bool TRUE on success or FALSE on failure.
     */
    #[\ReturnTypeWillChange] public function rollBack()
    {
     ...
     * @return int
     */
    #[\ReturnTypeWillChange] public function getPeakMemoryUsage()
    {
     ...
     */
    #[\ReturnTypeWillChange] public function getExecutedStatements()
    {
     ...
     * @return mixed
     */
    #[\ReturnTypeWillChange] public function __get($name)
    {
     ...
     * @param $value
     */
    #[\ReturnTypeWillChange] public function __set($name, $value)
    {
        $this->pdo->$name = $value;
    }
     ...
     * @return mixed
     */
    #[\ReturnTypeWillChange] public function __call($name, $args)
    {
